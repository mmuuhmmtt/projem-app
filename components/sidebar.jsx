        ...
        <div className="w-64 md:w-64 shrink-0 bg-[#ffffff] dark:bg-[#1a1a1a] border-r border-[#e5e5e5] dark:border-[#2d2d2d] flex flex-col h-full shadow-lg md:shadow-none">
            <div className="p-4 border-b border-[#e5e5e5] dark:border-[#2d2d2d] flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                    {/* AI Sembolü - Neural Network / Brain */}
                    <div className="relative">
                        <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#ea580c] to-[#c2410c] dark:from-[#ea580c] dark:to-[#c2410c] flex items-center justify-center shadow-md">
                        ...
                        {/* Glow efekti */}
                        <div className="absolute inset-0 rounded-lg bg-gradient-to-br from-[#ea580c] to-[#c2410c] opacity-20 blur-sm animate-pulse"></div>
                    </div>
